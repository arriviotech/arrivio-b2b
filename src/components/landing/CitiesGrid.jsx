            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex justify-between items-start mb-10">
                  <div>
                    <h3 className="text-4xl font-heading font-bold text-[#0f4c3a] mb-2">{activeLocation.name}</h3>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-3xl font-heading font-bold text-[#0f4c3a]">
            ...
            <div className="absolute inset-0 bg-[#0a1a13] rounded-3xl overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.5)] border border-white/[0.06]">
              ...
              <div className="absolute bottom-10 left-10 z-20">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <p className="text-white font-heading font-bold text-4xl mb-2 tracking-tight drop-shadow-lg">
