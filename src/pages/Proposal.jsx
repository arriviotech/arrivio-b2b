...
import ArixSharedDesignerStep from '../components/arix/ArixSharedDesignerStep';
              ...
              {!hasItems ? (
                ...
                {ARIX_ENABLED && hasItems && (
                  <section>
                    ...
                    <div className="space-y-4">
                      {hydratedProperties.map(property => {
                        const isShared = property.units?.[0]?.unitType?.toLowerCase().includes('shared');
                        return isShared ? (
                          <ArixSharedDesignerStep key={property.id} property={property} />
                        ) : (
